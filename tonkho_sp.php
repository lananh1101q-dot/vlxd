...
<head>
    ...
    <title>Tồn kho thành phẩm - Quản lý kho VLXD</title>
    ...
    <style>
        ...
        .sidebar{background:linear-gradient(180deg,#1e3a5f,#0d2137);height:100vh;position:fixed;width:250px;color:white;padding-top:20px;top:0;left:0;overflow-y:auto;z-index:100;box-shadow:4px 0 15px rgba(0,0,0,.2)}
        ...
        .badge-dvt{background:#dcfce7;color:#15803d;padding:3px 10px;border-radius:20px;font-size:.78rem}
    </style>
</head>
<body>
<nav class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a class="nav-link active" href="tonkho_sp.php" style="background:rgba(59,130,246,.3);color:#93c5fd!important"><i class="fas fa-cubes me-2"></i>Tồn kho thành phẩm</a></li>
...
<div class="main-content">
    <div class="page-header">
        <h1 class="mb-1" style="font-size:1.6rem"><i class="fas fa-cubes me-2"></i>Tồn kho thành phẩm</h1>
        <p class="mb-0 opacity-75">Danh sách tồn kho sản phẩm theo kho</p>
    </div>
    <div class="card">
        <div class="card-body p-0">
            <div class="p-3"><input class="form-control" id="searchInput" placeholder="🔍 Tìm theo kho, mã SP, tên..." oninput="filterTable()"></div>
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead><tr><th>Kho</th><th>Mã SP</th><th>Tên sản phẩm</th><th>ĐVT</th><th class="text-end">Số lượng tồn</th></tr></thead>
...
async function load(){
    try{
        ...
        if(!rows.length){tb.innerHTML='<tr><td colspan="5" class="text-center py-4 text-muted">Chưa có dữ liệu tồn kho thành phẩm.</td></tr>';return;}
